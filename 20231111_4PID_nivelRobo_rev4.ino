...
//Entradas dos valores de pwm que desejo para cada roda e a direção da roda. 
  ...
  {// Calcula a cada 1 segundo, a velocidade.
    ...
    veloc_linear_out = (theta_ponto_1_out + theta_ponto_2_out)*raio_roda/2;
    veloc_ang_robo_out = (theta_ponto_1_out - theta_ponto_2_out)/2*b; 
  ...
  Serial.print(output_robo_dir);// a ser controlada
  Serial.print("\t");
  Serial.print(veloc_linear_ref);
  Serial.print("\t");
  Serial.print(veloc_ang_robo_out);
  Serial.print("\t");
  Serial.print(veloc_ang_ref);
